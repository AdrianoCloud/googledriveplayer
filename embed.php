...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<link rel="stylesheet" href="https://api.flixstreamcdn.com/style.css">
	<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.4.1/css/bootstrap.min.css'><link rel="stylesheet" href="https://api.flixstreamcdn.com/style.css">
	<style type="text/css">
	/*!
 * Anti-adblock v2.1.0
...
<?php 
		...
		if ($data != '') {
		    ...
		    $sources = '[{"label":"FullHD","type":"video\/mp4","file":"./drive.php/?id='.$linkDropbox.'"}]';
			...
			$data = 'var player = jwplayer("bundlecodes");
						...
						player.addButton("https://api.flixstreamcdn.com/assets/images/giftdonation.svg", "Enviar Doação", function() {
    var win = window.open("https://www.paypal.com/paypalme/adrianocloud", "_blank");
    win.focus()
}, "donate");
