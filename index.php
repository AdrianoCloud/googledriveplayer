...
?>
 <!DOCTYPE html>
	...
	<title>Painel Google Drive 2021</title>
	...
	<div class="container" style="opacity:1;">
			...
			<div class="alert alert-danger" role="alert">
				<strong>
					<font size="3">Os seguintes erros foram encontrados</font>	
				</strong>
...
<body>
	<div class="container">
		...
		<form id="action-form" action="action.php" method="POST" accept-charset="utf-8">
		    <a class="btn btn-info btn-sm" href="?logout=true" role="button">Sair</a>
			<div class="form-group">
				<label class="font-weight-bold">Google Drive ID:</label>
				<input type="text" name="link" class="form-control" placeholder="1UCKOhtsCDnjQE6DTIF1b-OjEFES9AmqC"this.select()" required>
			</div>
				...
				<div class="col-md-11" id="sub">
					<div id="sub-block">
						<div class="row">
						    <div class="col-md-7">
						        <div class="form-group">
						        	<label class="font-weight-bold">Legenda:</label>
						        	<input type="text" class="form-control" name="sub[0]" placeholder="Ex: name.com/api/apipanel/drop/the.boss.baby.srt (opcional)" onclick="this.select()"> 
						        </div>
						    </div>
						    ...
						    <div class="col-md-4">
						        <div class="form-group">
						        	...
						        	<input type="text" class="form-control" name="label[0]" placeholder="Ex: English (opcional)" onclick="this.select()"> 
						        </div>
						    </div>
			...
			<div class="form-group">
				...
				<input type="text" name="poster" class="form-control" placeholder="Ex: https://image.tmdb.org/t/p/w600_and_h900_bestv2/68ot38BwgfZjkIYRiuvXCtKDxCL.jpg" onclick="this.select()">
			</div>

			<div class="form-group">
				<button type="submit" id="action-submit" class="btn btn-dark"> <span id="fa-loading"></i></span><i class="fa fa-cog"></i>
<span class="ml-2">Gerar Player</span>
</button>
			</div>
		</form>
		
		<div class="form-group">
			<label class="font-weight-bold">Embed Player Link:</label>
			<input type="text" id="url-encode" class="form-control" placeholder="O url após a codificação será exibido aqui..." onclick="this.select()">
		</div>

		<div class="form-group">
			<label class="font-weight-bold">Embed Player Iframe:</label>
			<textarea rows="5" class="form-control" id="iframe-encode" placeholder="O url com iframe após a codificação será exibido aqui..." onclick="this.select()"></textarea>
		</div>
